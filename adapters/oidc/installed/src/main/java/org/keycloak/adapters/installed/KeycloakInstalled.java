...
public class KeycloakInstalled {
    ...
    public static void main(String[] args) throws InterruptedException {
        KeycloakInstalled kc = new KeycloakInstalled(1);
        CallbackListener listener = kc.new CallbackListener();
        kc.deployment = new KeycloakDeployment() {
            @Override
    ...
    class CallbackListener implements HttpHandler {
        ...
        public void start() {
            ...
            System.out.println("Undertow started and listening on " + server.getListenerInfo().get(0).getAddress());
        }
